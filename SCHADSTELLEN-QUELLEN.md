...
- [BLD: CIPP Lateral Rehabilitation](https://bldllc.net/cipp-lateral-lining-rehabilitation/), Foto „Before – Infiltration entering system from annular space behind main CIPP liner“ im Browser angesehen. Unterschiedlich starke Wasserfäden und flächig feuchte Rohrbereiche statt gleichmäßig verteilter, gleich dicker Strahlen. Nur visuelle Wasserreferenz; das dort verwendete CIPP-Verfahren wird nicht in die DSS-Flex-Animation übernommen.
- [IBAK: Anschlusseinbindung mittels Injektionsmörtel](https://www.ibak.de/infos/events/messen/messe/anschlusseinbindung-mittels-injektionsmoertel), Anwenderbericht vom 01.02.2022 gelesen. Beschreibt lokale Anschlussbearbeitung, zunächst unbekannte Hohlräume hinter der Rohrwand und Bettungsdefizite. Grundlage für die Trennung von örtlicher Innenfläche und größerer Verpressung im umgebenden Boden. Keine Übernahme von Betriebsparametern.
...
Sieben ungleich verteilte, verschieden starke Wassereintritte, veränderliche Rinnsalquerschnitte, unregelmäßige Tropfenabstände und dunkle Feuchtespuren ersetzen die früheren gleichmäßigen Stränge. Der vollständige Schild fängt das Wasser unabhängig von Ansichtsschnitten ab; nach dem Anpressen endet der seitliche Ablauf, mit der Verfüllung endet die Infiltration.

Form, Ausdehnung, Tropfraten und Bodenschichten bleiben illustrative Modellannahmen. Die Fotos belegen keine verborgene dreidimensionale Hohlraumgeometrie oder konkrete Herstellermaße. Es wurde kein einzelner real vermessener Schaden rekonstruiert. Fremde Bilder sind nicht in die HTML-Dateien eingebettet.
