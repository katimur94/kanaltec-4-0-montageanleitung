...
export const stages=[
 ...
 {title:'Mörtel injizieren',tag:'07 / HOHLRAUM VERFÜLLEN',text:'Vom Zulauf am Schild wird der Mörtel in den Hohlraum an der Anschlusskante und in das umgebende Erdreich verpresst. Die Anschlussblase hält dabei den ursprünglichen Durchgang frei. Erst bei vollständiger Füllung leuchtet die rote Meldelampe am Drucksensor.',focus:'Schadstelle und Erdreich verfüllen · freier Anschlussquerschnitt',caption:'Erst Schlauchfüllung, dann Verfüllung der Schadstelle und des umgebenden Erdreichs. Die Anschlusswand bleibt innen unverändert; der Mörtel verkleinert den Anschluss nicht. Verpressung und Vollmeldung sind schematisch dargestellt.'},
