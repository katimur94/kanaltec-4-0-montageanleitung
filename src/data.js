...
export const PHASE={POSITION:0,BUMPER:1,SEAL:2,BLADDER:3,MORTAR:4,CURE:5,REMOVE:6};
export const stages=[
 {title:'Positionieren',tag:'01 / AUSRICHTEN',text:'Während der Fahrt ist der Bumper vakuumiert und flach: Die Schalung ist abgesenkt. Der Roboter positioniert sie unter dem Anschluss. Die Anschlussblase liegt mit drei vollständigen Windungen um die Welle. Vakuumiert ist jede Wandlage etwa 3 mm dick, die zusammenliegende Blase damit etwa 6 mm. Ihre starre runde Spitze ragt etwas durch die Schildöffnung.',focus:'Fahrt mit vakuumiertem Bumper',caption:'Unter „Schnitt & Sicht“ lassen sich Rohr, Schalung und Halterung unabhängig einstellen.'},
 {title:'Schild anpressen',tag:'02 / ABDICHTEN',text:'Erst wenn die Schalung die Anschlussposition erreicht hat, wird der Bumper mit Luft aufgeblasen. Er hebt die obere Baugruppe an und drückt das Schalungsschild gegen die Rohrinnenwand am Anschluss.',focus:'Bumper aufblasen und Schalung anpressen',caption:'Hub und Verformung sind schematisch; die Bewegung zeigt den Wechsel von Vakuum zur Luftfüllung.'},
 {title:'Dichtblase aufblasen',tag:'03 / SCHALUNG ABDICHTEN',text:'Nach dem Aufblasen des Bumpers erhält die separate Blase zwischen Schalungsträger und Schalungsschild Luft. Sie dehnt sich gegen das Schild aus und stellt die abschließende Abdichtung her. Die Anschlussblase bleibt währenddessen auf der Welle aufgewickelt.',focus:'Zwischenblase stellt die letzte Abdichtung her',caption:'Die schwarze Lage ist die Blase aus der PDF-Stückliste. Ihre Ausdehnung ist schematisch; unter „Schnitt & Sicht“ kannst du den Schalungsschnitt selbst einschalten.'},
 {title:'Anschlussblase einfahren',tag:'04 / ANSCHLUSS FORMEN',text:'Die Anschlussblase wird mit ihrem Außengewinde direkt in das Innengewinde der Welle eingeschraubt. Ihr wellenseitiges Ende ist starr, rund und etwa 70 mm im Durchmesser. Die gerade Stirnfläche sitzt fast bündig auf der flachen Wellenfläche. Dieses Endstück bleibt beim Wickeln und Aufblasen formstabil; darüber beginnt die flexible Blasenhaut. Nach dem Aufblasen von Bumper und Dichtblase dreht der Motor die Welle und wickelt die Anschlussblase vollständig ab. Am Ende steht die flache Fläche parallel zur Anschlussöffnung; die Blase führt ohne Restwicklung und ohne Knick gerade in den Anschluss. Erst jetzt erhält sie Luft und wird aufgeblasen.',focus:'Vollständig abwickeln · gerade ausrichten · dann aufblasen',caption:'Wickelverlauf nach Foto und ergänzender Systembeschreibung; Drei Windungen und etwa 3 mm je Wandlage nach Nutzerangabe. Falten und Einfahrweg bleiben schematisch; der Weg folgt der vollständig abgewickelten Materiallänge.'},
 {title:'Mörtel injizieren',tag:'05 / HOHLRAUM VERFÜLLEN',text:'Der Mörtelschlauch sitzt von unten am kleinen Zulauf neben der Blasenöffnung. Von dort gelangt der Injektionsmörtel hinter das Schild in die Schadstelle. Ist der Bereich voll, wirkt der Gegendruck auf den roten Drucksensor auf der anderen Seite der Öffnung: Die rote Meldelampe leuchtet.',focus:'Separater Zulauf und Drucksensor',caption:'Der Mörtel füllt zuerst den Schlauch, dann die Ausbruchstelle vom Zulauf aus. Der Wassereintritt versiegt mit zunehmender Füllung. Die rote Vollmeldung ist eine simulierte Anzeige.'},
 {title:'Aushärten lassen',tag:'06 / VERBINDUNG HERSTELLEN',text:'Bumper und Dichtblase halten das Schalungsschild bis zur erforderlichen Festigkeit angepresst. Die Anschlussblase bleibt im Anschluss. Die tatsächliche Wartezeit richtet sich nach Mörtel und Bedingungen vor Ort.',focus:'Der Mörtel verbleibt im Sanierungsbereich',caption:'Die Animationsdauer bildet keine reale Aushärtezeit ab.'},
 {title:'Ausschalen & kontrollieren',tag:'07 / FERTIGSTELLEN',text:'Nach dem Aushärten wird die Anschlussblase entspannt und durch Rückwärtsdrehen der Welle aufgewickelt. Die starre Spitze bleibt leicht über der Schildöffnung sichtbar. Danach wird die Dichtblase zwischen Schild und Träger entspannt. Anschließend wird der Bumper wieder vakuumiert: Die Schalung senkt sich ab und fährt in flacher Fahrtstellung weiter.',focus:'Aufwickeln, Dichtblase entspannen, Bumper vakuumieren',caption:'Der Mörtel bleibt zurück. Erst nach Einziehen der Anschlussblase, Entspannen der Zwischenblase und Absenken der Schalung beginnt die Weiterfahrt.'}
];
export const sources=[
 {title:'IBAK · MicroGator-Prospekt',url:'https://www.ibak.de/fileadmin/website/ansprechpartner/flyer_prospekte/fraeserprospekt_a4_de_en.pdf',note:'Größenabgleich und Fahrwagenaufbau. Roboterdetails und Verbindung zur Klappvorrichtung nach den ergänzenden Nutzerfotos rekonstruiert; kein Fräskopf.'},
 {title:'DiTom GmbH Kanaltechnik',url:'https://www.ditom-kanaltechnik.de/',note:'Hersteller-/Unternehmenszuordnung.'},
 {title:'Hermes Technologie · Kanaltec 4.0',url:'https://www.hermes-technologie.de/kanaltec-4-0/',note:'System, Einsatzbereiche und Drucküberwachung.'},
...
export const videos=[
 {id:'jWczYU40AhY',title:'KANALTEC 4.0 Stutzensanierungsroboter'},
 {id:'lrbtHgalpqc',title:'Videoreferenz 2 · Kanaltec 4.0'},
 {id:'k--FPQ0t1t8',title:'Videoreferenz 3 · Kanaltec 4.0'}
];
