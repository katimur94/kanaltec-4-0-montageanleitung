...
export const PHASE={MILL_OUTER:0,MILL_INNER:1,CHANGE:2,POSITION:3,BUMPER:4,SEAL:5,BLADDER:6,MORTAR:7,CURE:8,REMOVE:9};
export const stages=[
 {title:'Anschluss freifräsen',tag:'01 / VORBEREITEN',text:'Der Roboter fährt mit Fräswerkzeug ohne Schalung zur Schadstelle. Zuerst fräst er den in die Haltung einragenden Anschluss und Wurzeleinwuchs zurück. Danach bearbeitet er die Rohrinnenwand kreisförmig um den Anschluss, ungefähr eine Fräserbreite breit und eine Fräserstärke tief.',focus:'Eine Fräserbreite breit · eine Fräserstärke tief',caption:'Fräskopf und rot-schwarzer Fräser nach Nutzerfoto; Maße angenähert: 60 mm Durchmesser, 16 mm Stärke als Darstellungsannahme, keine Herstellermaße. Unter „Fräsdetail“ und „Schnitt & Sicht“ den Abtrag betrachten.'},
 {title:'Nut im Anschluss fräsen',tag:'02 / NUT FRÄSEN',text:'Der Roboter bereitet die Innenwand für die Mörteleinbindung vor und fräst rundum eine Nut etwa 5 cm hinter der zurückgefrästen Anschlusskante. Der vertiefte Bereich reicht über die Nut hinaus; dort kann Mörtel liegen, ohne den freien Durchgang zu verkleinern.',focus:'Umlaufende Nut · ca. 5 cm im Anschluss',caption:'50 mm Einstecktiefe nach Nutzerangabe, ab der mittleren Anschlusskante gemessen; die unregelmäßige Bruchkante weicht davon ab. Nut im Modell 16 mm hoch und 6 mm tief; zusätzliche Vertiefung 3 mm, bis 16 mm hinter die Nut. Diese Maße sind Darstellungsannahmen. Werkzeugführung ist eine schematische Verfahrensdarstellung.'},
 {title:'Zur Schalung wechseln',tag:'03 / WERKZEUGWECHSEL',text:'Das Fräswerkzeug wird abgesenkt und der Roboter fährt zurück. Außerhalb der Schadstelle erfolgt der Wechsel auf die Klappvorrichtung mit Schalung. Danach beginnt die bekannte Sanierungsfolge.',focus:'Fräser zurückziehen · Schalung übernehmen',caption:'Der Werkzeugwechsel außerhalb der Schadstelle wird als Szenenwechsel dargestellt. Fräser und Schalung sind nie gleichzeitig montiert.'},
 {title:'Positionieren',tag:'04 / AUSRICHTEN',text:'Während der Fahrt ist der Bumper vakuumiert und flach: Die Schalung ist abgesenkt. Der Roboter positioniert sie unter dem Anschluss. Die Anschlussblase liegt mit drei vollständigen Windungen um die Welle. Vakuumiert ist jede Wandlage etwa 3 mm dick, die zusammenliegende Blase damit etwa 6 mm. Ihre starre runde Spitze ragt etwas durch die Schildöffnung.',focus:'Fahrt mit vakuumiertem Bumper',caption:'Unter „Schnitt & Sicht“ lassen sich Rohr, Schalung und Halterung unabhängig einstellen.'},
 {title:'Schild anpressen',tag:'05 / ABDICHTEN',text:'Erst wenn die Schalung die Anschlussposition erreicht hat, wird der Bumper mit Luft aufgeblasen. Er hebt die obere Baugruppe an und drückt das Schalungsschild gegen die Rohrinnenwand am Anschluss.',focus:'Bumper aufblasen und Schalung anpressen',caption:'Hub und Verformung sind schematisch; die Bewegung zeigt den Wechsel von Vakuum zur Luftfüllung.'},
 {title:'Dichtblase aufblasen',tag:'06 / SCHALUNG ABDICHTEN',text:'Nach dem Aufblasen des Bumpers erhält die separate Blase zwischen Schalungsträger und Schalungsschild Luft. Sie dehnt sich gegen das Schild aus und stellt die abschließende Abdichtung her. Die Anschlussblase bleibt währenddessen auf der Welle aufgewickelt.',focus:'Zwischenblase stellt die letzte Abdichtung her',caption:'Die schwarze Lage ist die Blase aus der PDF-Stückliste. Ihre Ausdehnung ist schematisch; unter „Schnitt & Sicht“ kannst du den Schalungsschnitt selbst einschalten.'},
 {title:'Anschlussblase einfahren',tag:'07 / ANSCHLUSS FORMEN',text:'Die Anschlussblase wird mit ihrem Außengewinde direkt in das Innengewinde der Welle eingeschraubt. Ihr wellenseitiges Ende ist starr, rund und etwa 70 mm im Durchmesser. Die gerade Stirnfläche sitzt fast bündig auf der flachen Wellenfläche. Dieses Endstück bleibt beim Wickeln und Aufblasen formstabil; darüber beginnt die flexible Blasenhaut. Nach dem Aufblasen von Bumper und Dichtblase dreht der Motor die Welle und wickelt die Anschlussblase vollständig ab. Am Ende steht die flache Fläche parallel zur Anschlussöffnung; die Blase führt ohne Restwicklung und ohne Knick gerade in den Anschluss. Erst jetzt erhält sie Luft und wird aufgeblasen.',focus:'Vollständig abwickeln · gerade ausrichten · dann aufblasen',caption:'Wickelverlauf nach Foto und ergänzender Systembeschreibung; Drei Windungen und etwa 3 mm je Wandlage nach Nutzerangabe. Falten und Einfahrweg bleiben schematisch; der Weg folgt der vollständig abgewickelten Materiallänge.'},
 {title:'Mörtel injizieren',tag:'08 / HOHLRAUM VERFÜLLEN',text:'Vom Zulauf am Schild wird der Mörtel zunächst in den Hohlraum und dann zusammenhängend entlang der vorbereiteten Anschlusswand durch die Nut bis darüber hinaus verpresst. Die Anschlussblase hält dabei den ursprünglichen Durchgang frei. Erst bei vollständiger Füllung leuchtet die rote Meldelampe am Drucksensor.',focus:'Lückenlos bis über die Nut · freier Anschlussquerschnitt',caption:'Erst Schlauchfüllung, dann Hohlraum und Anschlusswand. Der Mörtel liegt in der ausgefrästen Vertiefung und verkleinert den Anschluss nicht. Verpressung und Vollmeldung sind schematisch dargestellt.'},
 {title:'Aushärten lassen',tag:'09 / VERBINDUNG HERSTELLEN',text:'Bumper und Dichtblase halten das Schalungsschild bis zur erforderlichen Festigkeit angepresst. Die Anschlussblase bleibt im Anschluss. Die tatsächliche Wartezeit richtet sich nach Mörtel und Bedingungen vor Ort.',focus:'Der Mörtel verbleibt im Sanierungsbereich',caption:'Die Animationsdauer bildet keine reale Aushärtezeit ab.'},
 {title:'Ausschalen & kontrollieren',tag:'10 / FERTIGSTELLEN',text:'Nach dem Aushärten wird die Anschlussblase entspannt und durch Rückwärtsdrehen der Welle aufgewickelt. Die starre Spitze bleibt leicht über der Schildöffnung sichtbar. Danach wird die Dichtblase zwischen Schild und Träger entspannt. Anschließend wird der Bumper wieder vakuumiert: Die Schalung senkt sich ab und fährt in flacher Fahrtstellung weiter.',focus:'Aufwickeln, Dichtblase entspannen, Bumper vakuumieren',caption:'Der Mörtel bleibt zurück. Erst nach Einziehen der Anschlussblase, Entspannen der Zwischenblase und Absenken der Schalung beginnt die Weiterfahrt.'}
];
