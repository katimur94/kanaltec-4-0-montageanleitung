...
export const stages=[
 ...
 {title:'Mörtel injizieren',tag:'05 / HOHLRAUM VERFÜLLEN',text:'Der Mörtelschlauch sitzt von unten am kleinen Zulauf neben der Blasenöffnung. Von dort gelangt der Injektionsmörtel hinter das Schild in die Schadstelle. Ist der Bereich voll, wirkt der Gegendruck auf den roten Drucksensor auf der anderen Seite der Öffnung: Die rote Meldelampe leuchtet.',focus:'Separater Zulauf und Drucksensor',caption:'Türkis zeigt den Mörtelfluss. Die rote Vollmeldung ist eine simulierte Anzeige, kein realer Messwert.'},
